...
public class JbpmAction extends DefaultActionSupport{
	...
	public String deploy(){
		ClassPathResource classPathResource = new ClassPathResource("jpdl/order.zip");
	...
	public String view(){
		...
		listHistoryActivityInstance = historyService.createHistoryActivityInstanceQuery().executionId(executionId).list();
	...
	public void setListHistoryActivityInstance(
			List<HistoryActivityInstance> listHistoryActivityInstance) {
	...
	public void setListHistoryProcessInstance(
			List<HistoryProcessInstance> listHistoryProcessInstance) {
